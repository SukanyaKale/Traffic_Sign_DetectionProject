...
'''ipcam_link = "https://"
ip = 0
video_source = int(input("Enter video source (O for Webcam, 1 for IpCam): "))
if(video_source == 1):
    ip = input("Enter Ip Adress: ")
    ipcam_link = ipcam_link+ip+"/video"
    # print(ipcam_link)
    cap = cv2.VideoCapture(ipcam_link)
